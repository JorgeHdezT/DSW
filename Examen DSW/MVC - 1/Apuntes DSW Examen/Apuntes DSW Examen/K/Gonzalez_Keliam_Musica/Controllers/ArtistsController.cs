...
namespace Gonzalez_Keliam_Musica.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var artist = _context.Artists.OrderByDescending(a => a.ArtistId).ToList();
            return View(artist);
        }
        ...
        {
            var maxArtistId = _context.Artists.Max(a => (int?)a.ArtistId) ?? 0; // Obtener el valor máximo o 0 si no hay registros
        ...
        public IActionResult DiscosArtist(int? id)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (artist != null)
            {
                ...
                //var cancionesToDelete = _context.Tracks.Where(a => a.AlbumId == artist.ArtistId);

                // foreach (var item in cancionesToDelete)
                //{
