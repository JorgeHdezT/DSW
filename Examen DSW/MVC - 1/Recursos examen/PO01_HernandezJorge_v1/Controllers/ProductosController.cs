...
namespace PO01_ApellidoNombre_v1.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(HernandezContext context)
        {
            _context = context;
        }
        ...
        {
            //Ordeno la lista de forma descendiente, por el codigo del producto y recojo solo 15 elementos.
            var hernandezContext = _context.Productos.Include(p => p.GamaNavigation)
                .OrderByDescending(a => a.CodigoProducto)
                .Take(15)
                .ToListAsync();


            return View(await hernandezContext);
        }
